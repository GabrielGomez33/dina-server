// File: test/visuals/renderSystemsTest.ts
// ============================================================================
// DINA VISUALS — RENDER-SYSTEMS PROOF HARNESS (phase 2 backend units)
// ============================================================================
...
//
//   run:  npx ts-node test/visuals/renderSystemsTest.ts
// ============================================================================

import { bindWorkflow, TEMPLATE_IMAGE_BASIC, WorkflowBindError } from '../../src/modules/visuals/systems/workflowTemplates';
import { ProgressMapper } from '../../src/modules/visuals/systems/progressMapper';
import { EtaEstimator, mergeCalibration } from '../../src/modules/visuals/core/etaEstimator';
import { ComfyClient, ComfyError, ComfyEvent, ComfyTransport } from '../../src/modules/visuals/systems/comfyClient';
...
async function main(): Promise<void> {
  console.log('════════════════════════════════════════════════');
  console.log('   DINA VISUALS — RENDER SYSTEMS PROOFS');
  console.log('════════════════════════════════════════════════');
