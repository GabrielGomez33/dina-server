// File: src/modules/visuals/core/etaEstimator.ts
// ============================================================================
// DINA VISUALS — ETA ESTIMATION (pure logic)
// ============================================================================
...
//      on THIS box (stored in visuals_calibration, seeded by the calibration
