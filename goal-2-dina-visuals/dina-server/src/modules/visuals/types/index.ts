// File: src/modules/visuals/types/index.ts
// ============================================================================
// DINA VISUALS MODULE — TYPE CONTRACT
// ============================================================================
// The single source of truth for every shape the visuals module speaks:
...
export interface VisualsTenant {
  id: string;
  name: string;
  slug: string;
  plan: PlanTier;
...
export interface VisualsMembership {
  id: string;
  tenantId: string;
...
export interface VisualsProject {
  id: string;
  tenantId: string;
  slug: string;
  ownerUserId: string;
...
export interface VisualsAudioTrack {
  id: string;
  projectId: string;
  filename: string;
  storagePath: string;
...
export interface VisualsGeneration {
  id: string;
  projectId: string;
  kind: GenerationKind;
...
/** Structural view of a DinaUniversalMessage — the fields the visuals module
...
export interface VisualsDumpMessage {
  id: string;
...
export interface VisualsSessionInfo {
  userId: string;
  sessionId: string;
}

/** Uniform result each visuals handler returns (the orchestrator wraps it into
 *  a DinaResponse, exactly like mirror handlers). */
export interface VisualsHandlerResult {
  success: boolean;
  data?: any;
